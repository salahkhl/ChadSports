...
contract ChadStaking is Ownable {
    ...
    function stakeBatch(uint8 _rank1, uint8 _rank2, uint8 _rank3, uint8 _rank4) public changeRankings {
    ...
    function innerSwap(uint _submissionId, uint fromPosition, uint toPosition) public changeRankings {
    ...
    function outerSwap(uint _submissionId, uint position, uint tokenId) public changeRankings {
    ...
    function unstakeBatch(uint256 _submissionId) public reentrancyGuard {
